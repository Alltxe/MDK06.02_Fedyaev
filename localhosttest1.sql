...
--
-- Хост: localhost
-- Время создания: Сен 11 2024 г., 14:55
...
--
CREATE DATABASE IF NOT EXISTS `db_vgu_test` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `db_vgu_test`;
...
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2021-10-23 09:41:44'),
...
INSERT INTO `my_table` (`id`, `name`, `surname`, `age`) VALUES
(1, 'Саша', 'Радыгин', 18),
(1, 'Саша', 'Радыгин', 18);
...
(129, 0, 'config', 'config_encryption', 'a9b0677652df52e2e4674ce8e49a4248', 0),
...
(127, 0, 'config', 'config_email', 'pawel_sam@mail.ru', 0),
...
(128, 0, 'config', 'config_url', 'http://pawel-sam.ru/vgu/', 0);
...
(1, 1, 'admin', '1a24abe46febcf56e0dd3658cd74a17f29abfa35', 'afefd657b', '', '', 'pawel_sam@mail.ru', '', '31.173.100.186', 1, '2021-10-23 09:40:49');
...
ALTER TABLE `product_description`
  ...
  ADD KEY `name` (`name`);
ALTER TABLE `product_description` ADD FULLTEXT KEY `description` (`description`);
ALTER TABLE `product_description` ADD FULLTEXT KEY `tag` (`tag`);
...
--
ALTER TABLE `setting`
  MODIFY `setting_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=130;
...
--
-- База данных: `db_vgu_test3`
--
CREATE DATABASE IF NOT EXISTS `db_vgu_test3` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `db_vgu_test3`;
